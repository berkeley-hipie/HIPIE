...
if __name__ == "__main__":
    ...
    args = parse_args()
    trackers.extend(trackerlist(name='HIPIE', parameter_name=args.name, dataset_name=dataset_name,
                                run_ids=None, display_name='HIPIE'))
    ...
    # print_per_sequence_results(trackers, dataset, "HIPIE")
