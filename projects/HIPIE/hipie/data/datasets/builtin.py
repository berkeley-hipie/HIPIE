...
from .register_seginw import register_all_seginw
from .register_cityscapes_parts import register_all_cityscapes_parts
...
from .register_ade20k_panoptic import register_all_ade20k_panoptic
from .register_pascal import register_all_pascal21,register_all_ctx59,register_all_ctx459,register_all_pascal_parts
from .register_ade_20k_full import register_all_ade20k_full
from .register_odinw import register_all_odinw
from .paco import register_all_paco_dataset
if __name__.endswith(".builtin"):
    ...
    register_all_cityscapes_parts(_root)
    register_all_paco_dataset(_root)