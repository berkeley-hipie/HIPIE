...
PASCAL_PARTS_CATEGORIES = [{'id': 1, 'name': 'aeroplane body', 'color': [231, 4, 237]},
...
PASCAL_PARTS_PARTS_ONLY = [{'id': 1, 'name': 'aeroplane body', 'color': [30, 178, 112]},
...
def register_all_ctx59(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        DatasetCatalog.register(
            name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext="png", image_ext="jpg",dataset_name='pascal_context_59')
        )
...
def register_all_pascal21(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        DatasetCatalog.register(
            name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext="png", image_ext="jpg",dataset_name='pascal_voc_21')
        )
        MetadataCatalog.get(name).set(
            stuff_classes=meta["stuff_classes"][:],
            thing_dataset_id_to_contiguous_id={},  # to make Mask2Former happy
...
def register_all_ctx459(root):
    ...
    for name, dirname in [("train", "training"), ("val", "validation")]:
        ...
        DatasetCatalog.register(
            name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext="tif", image_ext="jpg",dataset_name='pascal_context_459')
        )
        MetadataCatalog.get(name).set(
            stuff_classes=meta["stuff_classes"][:],
            thing_dataset_id_to_contiguous_id={},  # to make Mask2Former happy
...
def register_all_pascal_parts_only(root):
    ...
    for name, dirname in [("train", "training_merged"), ("val", "validation_merged"),("test","test_merged")]:
        ...
        DatasetCatalog.register(
            name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext="tif", image_ext="jpg",dataset_name='pascal_parts_merged')
        )
        MetadataCatalog.get(name).set(
            stuff_classes=meta["stuff_classes"][:],
            thing_dataset_id_to_contiguous_id={},  # to make Mask2Former happy
...
def register_all_pascal_parts(root):
    ...
    for name, dirname in [("train", "training_pano"), ("val", "validation_pano"),("test","test_pano")]:
        image_dir = os.path.join(data_root, "VOCdevkit/VOC2010/JPEGImages")
        gt_dir = os.path.join(root, "labels", dirname)
        name = f"pascal_parts_{name}"
        DatasetCatalog.register(
            name, lambda x=image_dir, y=gt_dir: load_sem_seg(y, x, gt_ext="tif", image_ext="jpg",dataset_name='pascal_parts_pano')
        )
        MetadataCatalog.get(name).set(
            stuff_classes=meta["stuff_classes"][:],
            thing_dataset_id_to_contiguous_id={},  # to make Mask2Former happy
